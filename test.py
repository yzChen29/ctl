...
#     if not (i == 36 or i == 37):
#         print(f'kubectl create -f /Users/chenyuzhao/Desktop/UCSD项目/server/job/job_{i}.yaml')
#
#
# # for i in [64, 128, 256]:
# #     # print(f'rm -f /datasets/codes/ctl_cifar100_fully_connect_fs256_{i}_Mar2')
# #     # print(f'mkdir /datasets/codes/ctl_cifar100_fully_connect_fs256_{i}_Mar2')
# #     print(f'cp -r /datasets/codes/ctl_cifar100_connect_fs256_32_Mar2/ctl /datasets/codes/ctl_cifar100_fully_connect_fs256_{i}_Mar2')
...
import random
print(index_list_trial3)
random.shuffle(index_list_trial3)
...
label_name_list = []
for i in range(20):
        label_ind_list.append(index_list_trial3[i*5: (i+1)*5])
        tmp_list = []
        for j in range(5):
                tmp_list.append(data_label_index_dict_inv[label_ind_list[-1][j]])
        label_name_list.append(tmp_list)


b = {i: list(data_name_hier_dict_100_trial3[i].keys()) for i in data_name_hier_dict_100_trial3}
...
for i in b:
        ...
        for j in b[i]:
                temp_dict = {}
                for k in range(5):
                        cur_class = label_name_list[ind][k]
                        temp_dict[cur_class] = {}
                ind += 1
                res_dict[i][j] = temp_dict
