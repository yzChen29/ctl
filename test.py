# a = '''{'physical_entity': -1, 'abstraction': -2, 'matter': -3, 'causal_agent': -4, 'object': -5, 'bubble': 971,
...
#                                                 'unicycle': {}}}}
#
#     todo_dict ={'init':init_dict}
#     todo_list = ['init']
#     res_list = []
#     res_key_list = []
#     def test(todo_list, todo_dict, res_list, res_key_list):
#         if len(todo_list) == 0:
#             pass
#
#         curr_key = todo_list[0]
#         curr_dict = todo_dict[curr_key]
#         curr_key_list = list(curr_dict.keys())
#         if len(curr_key_list)!=0:
#             res_list.append(curr_key_list)
#             res_key_list.append(curr_key)
#         todo_list.extend(curr_key_list)
#         todo_list.remove(curr_key)
#         todo_dict.pop(curr_key)
#         for i in curr_key_list:
#             todo_dict[i] = curr_dict[i]
#
#         for j in curr_key_list:
#             test(todo_list, todo_dict,res_list, res_key_list)
#
#     test(todo_list, todo_dict, res_list, res_key_list)
#     for i in range(len(res_list)):
#         print(f'{res_list[i]},   #{res_key_list[i]}')
#
#         # all_dic
#         #
#         # res_list.append(list(all_dict[key].keys()))
#         # todo_dict.pop(key)
#         # for
#         # todo_dict.extend(list(all_dict.keys()))
#     #     # test()
#     #
#     # print(list(a_dict['mammal'].keys()))
#     #
print(list(range(30)))